KdDataLayer = function(args) {
  ...
  this.rawInsertMethod = this.tracesColl.rawCollection().insertOne ? 'insertOne' : 'insert';
};
...
KdDataLayer.prototype._createCappedCollection = function (name, size) {
  ...
  return new Mongo.Collection(name, { _preventAutopublish: true });
}
...
KdDataLayer.prototype.setTimeEvent = function(data) {
  this.timeEventsColl.rawCollection()[this.rawInsertMethod](data, function(err) {
    if(err) {
